        ...
        <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-6 gap-6">
            ...
            <div className="md:col-span-2  rounded-2xl  space-y-2">
                ...
                <div className="space-y-2 pt-4">
                    <button className="flex justify-center items-center font-semibold cursor-pointer gap-2 w-full shadow-sm py-2 rounded-lg transition">
            ...
            <div className="md:col-span-4 space-y-6">
                ...
                <div className="bg-white shadow rounded-2xl p-6">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        <button className="flex flex-col justify-center items-center  bg-blue-100 cursor-pointer hover:bg-blue-200 py-3 rounded-lg transition">
                            <IoIosCall />
                            Call
                        </button>
                        <button className="flex flex-col justify-center items-center  bg-green-100 cursor-pointer hover:bg-green-200 py-3 rounded-lg transition">
                            <MdOutlineTextsms />
                            Text
                        </button>
                        <button className="flex flex-col justify-center items-center  bg-purple-100 cursor-pointer hover:bg-purple-200 py-3 rounded-lg transition">
                            <CiVideoOn />
                            Video
                        </button>
                    </div>
